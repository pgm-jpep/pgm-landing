...
const PasswordInput = ({ variation = Variations.PINK, onChange, value }) => {
  ...
  return (
    <InputContainer>
      ...
      <InputFieldBox >
        <InputField color={inputColor} type='password' placeholder="Enter password to continue" onChange={onChange} value={value}/>
      </InputFieldBox>
